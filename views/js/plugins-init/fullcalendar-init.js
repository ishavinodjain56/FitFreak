! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        var i = e("<form ></form>");
        i.append("<div class='row'></div>"), i.find(".row").append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Event Name</label><input class='form-control' placeholder='Enter Event Name' type='text' name='title'/></div></div>").append("<div class='col-md-6'><div class='form-group'><label class='control-label'> Category </label><select class='form-control' name='category1'></select></div></div>").find("select[name='category1']").append("<option value='Running'>Running</option>").append("<option value='Cycling'>Cycling</option>").append("<option value='Yoga'>Yoga</option></div></div>").append("<div class='row'></div>"),i.find(".row").append("<div class='col-md-6'><label class='control-label'>Distance</label><input class='form-control' placeholder='Enter distance in Kms' type='text' name='kms'/></div></div>").append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Status</label><select class='form-control' name='category'></select></div></div>").find("select[name='category']").append("<option value='UnFinished'>UnFinished</option>").append("<option value='Finished'>Finished</option>").append("<option value='Inprogress'>Inprogress</option></div></div>").append("<div class='row'></div>"),i.find(".row").append("<div class='col-md-6'><label class='control-label'>GoalDate</label><input class='form-control' placeholder='Insert Event Name' type='date' name='goaldate'/></div></div>").append("<div class='col-md-6'><div class='form-group'><label class='control-label'>GoalTime</label><input class='form-control' placeholder='Insert Event Name' type='time' name='goaltime'/></div></div>");o.$modal.find(".delete-event").hide().end().find(".save-event").show().end().find(".modal-body").empty().prepend(i).end().find(".save-event").unbind("click").on("click", function() {
            i.submit();}); o.$modal.find("form").on("submit", function() {
